...
//#define TWOP_CALB      //Two-point calibration method两点校准))
...
#define ADJ_REF_UAX1                       6       //通道4基准源校正值  
#define ADJ_REF_UAX2                       7       //通道4基准源校正值  
#define ADJ_REF_UAY1                       8       //通道4基准源校正值  
#define ADJ_REF_UAY2                       9       //通道4基准源校正值  
#define ADJ_REF_UA_A                       10       //通道4基准源校正值  
#define ADJ_REF_UA_B                       11     //通道4基准源校正值  
#define ADJ_REF_UBX1                      12       //通道4基准源校正值  
#define ADJ_REF_UBX2                       13       //通道4基准源校正值  
#define ADJ_REF_UBY1                       14     //通道4基准源校正值  
#define ADJ_REF_UBY2                       15     //通道4基准源校正值  
#define ADJ_REF_UB_A                       16     //通道4基准源校正值  
#define ADJ_REF_UB_B                       17     //通道4基准源校正值  
#define ADJ_REF_UCX1                       18     //通道4基准源校正值  
#define ADJ_REF_UCX2                       19   //通道4基准源校正值  
#define ADJ_REF_UCY1                       20     //通道4基准源校正值  
#define ADJ_REF_UCY2                       21     //通道4基准源校正值  
#define ADJ_REF_UC_A                       22     //通道4基准源校正值  
#define ADJ_REF_UC_B                       23     //通道4基准源校正值  
