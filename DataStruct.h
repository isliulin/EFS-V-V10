...
/*  
  ...
  */
   ...
   // unsigned char g_unGPRSTX_Buff[MAX_TXBUFF_101_LEN];          //GPRSÊı¾İ·¢ËÍÊı×é 
    ...
    unsigned int bFrameReceived[COMM_PORT_NUM];   //»º³åÇø½ÓÊÕĞÂÊı¾İ±êÖ¾
   ...
   // const unsigned char VerNum[2]={0,22};   //×¢:  ĞŞ¸ÄÉú²úĞÂµÄ°æ±¾  V21
    ...
    extern unsigned int bFrameReceived[COMM_PORT_NUM];   //»º³åÇø½ÓÊÕĞÂÊı¾İ±êÖ¾
...
//=============================== µ÷ÓÃÍâ²¿²ÎÊı ===============================///
        ...
        unsigned char phone_perm[4];	//          5        4         3        2       1      0
						...
						//ÊÖ»úµÄÈ¨ÏŞ¿ØÖÆ×Ö
        unsigned char SMS_array[28];      /////////µÈ´ı·¢ËÍµÄ¹ÊÕÏ£¬ÁùÖÖÇé¿ö£¬4¸öÊÖ»úºÅ£¬¹²24¸ö£»					
